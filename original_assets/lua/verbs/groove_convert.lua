...
function Convert:canExecuteWithTarget(unit, endPos, targetPos, strParam)
    ...
    return targetUnit and not targetUnit.unitClass.isStructure and not targetUnit.unitClass.isCommander and Wargroove.areEnemies(unit.playerId, targetUnit.playerId)
end
